import { ProductsState, CartProduct, ProductsAction, ProductsTypes } from './types'
...
export default function cartReducer(state: ProductsState = INITIAL_STATE, action: ProductsAction): ProductsState{
    switch (action.type) {
